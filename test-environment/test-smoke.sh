...
#
# TEST SCENARIOS:
#   1. Quick operations     - No timers should appear (fast candidate source + fast Gemini)
#   2. Slow candidate source - Progress timer appears after 5 seconds
#   3. Slow Gemini          - Inactivity timer appears after 30 seconds
...
run_test() {
    ...
    echo ""
    eval "env $env_vars timeout $timeout_dur $AGENA_BIN $task" || {
        local exit_code=$?
...
main() {
    ...
    run_test \
        ...
        "demo-task" \
        "No timers - candidate source and Gemini both respond quickly" \
        "MOCK_GEMINI_FIX=1 MOCK_GEMINI_DELAY=0.5" \
        30
    ...
    # Test 3: Slow Gemini (inactivity timer after 30s)
    run_test \
        "Test 3: Slow Gemini Response" \
        "slow-gemini-task" \
        "'Waiting for Gemini...' timer appears after 30 seconds of inactivity" \
        "MOCK_GEMINI_INACTIVITY_TEST=1 MOCK_GEMINI_FIX=1" \
        120
    ...
    run_test \
        ...
        "MOCK_GEMINI_EMPTY_MSG=1 MOCK_GEMINI_FIX=1" \
        30
    ...
    run_test \
        ...
        "MOCK_GEMINI_MODE=tiny MOCK_GEMINI_FIX=0" \
        30
    ...
    run_test \
        ...
        "MOCK_GEMINI_MODE=small MOCK_GEMINI_FIX=0" \
        30
    ...
    run_test \
        ...
        "MOCK_GEMINI_MODE=mixed MOCK_GEMINI_FIX=0" \
        30
    ...
    run_test \
        ...
        "MOCK_GEMINI_MODE=large MOCK_GEMINI_FIX=0" \
        30
    ...
    run_test \
        ...
        "MOCK_GEMINI_MODE=alternating MOCK_GEMINI_FIX=0" \
        30
    ...
    run_test \
        ...
        "MOCK_GEMINI_MODE=ansi MOCK_GEMINI_FIX=0" \
        30
    ...
    run_test \
        ...
        "MOCK_GEMINI_MODE=newlines MOCK_GEMINI_FIX=0" \
        30
    ...
    run_test \
        ...
        "MOCK_GEMINI_MODE=rapid MOCK_GEMINI_FIX=0" \
        30
    ...
    run_test \
        ...
        "MOCK_GEMINI_MODE=multibyte MOCK_GEMINI_FIX=0" \
        30
    ...
    echo "  3. Slow Gemini       - Inactivity timer after 30s"
