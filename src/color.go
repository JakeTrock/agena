...
// ColorGemini returns dim italic text for Gemini output
func ColorGemini(text string) string {
...
// StartupBanner creates the startup banner with celestial ASCII art
